...
namespace hypeJunction\Wall\Tests;

use PHPUnit\Framework\TestCase;

/**
 * Auto-generated migration regression guard for plugin "hypewall".
 *
...
final class MigrationRegressionTest extends TestCase
{
    ...
    public function testManifestUsesStringLiterals(): void
    {
        ...
        // MyClass::SUBTYPE (a real class-constant access) fatals at manifest
        // parse. MyClass::class is a compile-time magic constant that resolves
        // to the FQCN string WITHOUT autoloading, so it is safe — this plugin
        // ships 'class' => Post::class and renders on 7.x. Only flag ::CONST.
        $src = self::manifestSource();

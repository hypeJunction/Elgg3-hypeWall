...
return function() {
	elgg_register_event_handler('init', 'system', function () {
		...
		// Display wall form
		elgg_extend_view('page/layouts/elements/content', 'page/components/wall', 100);
		...
		elgg_register_plugin_hook_handler('prepare', 'notification:publish:object:hjwall', [
			Notifications::class,
			'formatMessage'
		]);
		...
		elgg_register_plugin_hook_handler('container_permissions_check', 'object', [
			Permissions::class,
			'containerPermissionsCheck'
		]);
		...
		elgg_register_plugin_hook_handler('register', 'menu:wall:quick_links', [Menus::class, 'setupQuickLinks']);
